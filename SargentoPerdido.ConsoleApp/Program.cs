...
namespace SargentoPerdido.ConsoleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                Console.Write("Digite a posição X inical do sargento: ");
                pX = Convert.ToInt32(Console.ReadLine());

                Console.Write("Digite a posição Y inical do sargento: ");
                pY = Convert.ToInt32(Console.ReadLine());

                Console.Write("Digite a direção ou referencia inicial do sargento: ");
                referenciaatual = Convert.ToChar(Console.ReadLine().ToUpper());
                Console.WriteLine("Digite as instruções do sargento ( Ex: DDEEE )  : ");
